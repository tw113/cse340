...
function buildVehicleImageDisplay($images, $vehicle) {
  $dv = '<ul id="inv-img-display">';
  foreach ($images as $image) {
    $dv .= '<li>';
    $dv .= "<img src='$image[imgPath]' alt='Image of $vehicle[invMake] $vehicle[invModel] on phpmotors.com'>";
    $dv .= '</li>';
  }
  $dv .= '</ul>';
  return $dv;
